...
データベース未指定で起動するとウェルカム画面が表示されます。「**データベースを開く**」ボタンからネイティブのフォルダ選択ダイアログで RocksDB ディレクトリを選びます。

![ウェルカム画面](screenshot/screenshot_01.png)

### メイン画面

データベースを開くと、カラムファミリーがドロップダウンに表示されます。テーブル上で閲覧・検索・ソート・編集・インポート・エクスポートが行えます。

![メイン画面](screenshot/screenshot_02.png)

### エントリー編集ダイアログ

モーダルからキーとバリューを追加・編集できます。JSON のフォーマット / 圧縮機能、リアルタイム検証付きです。

![エントリー編集ダイアログ](screenshot/screenshot_03.png)
